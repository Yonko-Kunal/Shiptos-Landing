...
const Woking = () => {
    ...
    return (
        <>
            <div className='flex flex-col items-center w-full px-8 2xl:px-24 2xl:pt-36 pt-24 gap-8'>
            ...
            <section
                ref={sectionRef}
                className='relative w-full 2xl:h-[80vh] h-screen overflow-hidden bg-background flex items-center'
            >
                <div
                    ref={trackRef}
                    className='flex gap-4 w-max px-8 2xl:px-24 will-change-transform'
                >
                    <div className='w-[calc((100vw-4rem-2rem)/3)] 2xl:w-[calc((100vw-12rem-3rem)/4)] shrink-0'>
